...
function TurnoJugador(props) {
  ...
  const estiloSeleccionado = {
    backgroundColor: "blue", // Cambia el color de fondo a azul cuando está seleccionado
    // Otros estilos de fondo aquí si es necesario
  };
// -------------------------RETURN-------------------------
// -------------------------RETURN-------------------------
// -------------------------RETURN-------------------------
// -------------------------RETURN-------------------------
  return (
    <DivCard>
      {props.children}
      <Header>
        Tú puntaje | Puntaje PC
        <br></br>
          {puntajeUsuario} {tab}{tab}~{tab}{tab} {puntajePC}
      </Header>   
         <div>
        <button>
      ...
      <div className="items">
        ...
        <div className="item">
          <button
            ...
            style={
              jugadaUsuario === "../assets/img/tijera-removebg-preview.png"
                ? estiloSeleccionado
                : {}
            }
          >
